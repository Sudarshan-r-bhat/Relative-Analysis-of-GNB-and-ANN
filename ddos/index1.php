...
<body>
   ...
   <div class="header-top-area">
    ...
    <div class="main-menu-area mg-tb-40">
        <div>
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:white;;margin-top:-39px">
				<div class="container">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        <li style="background-color:#e6e5e5"><a href="index1.php"><i class="notika-icon notika-house"></i> Home</a>
                        </li>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="dropdone-nk mg-t-30">
                        <div class="cmp-tb-hd">
                          <center>  <h1 style="padding:38px"><i>Welcome&nbsp;<?php echo $_SESSION['email'];?></i></h1>
							<h2>Please Click The Option.......</h2>
                           <h2>Upload File:<h2></center>
                        </div>
