...
# saved_model = pickle.dumps(classifier)  # method1: save as string
# joblib.dump(classifier, "classificationModel.pkl")  # method2: save as a file
...
# prediction = classifier.predict(X_test)  # use the classifier directly
cm = confusion_matrix(y_test, prediction)

# log_result = "confusion matrix: \r\n" + cm + "\r\nAccuracy: " + accuracy_score(y_test, prediction) * 100
# with open("DetectionResult/resultLog.txt", "w") as f:
#     f.write(log_result)
#     f.close()
...
for i in range(3):
    if i == 0:
        ...
        plt.savefig("DetectionResult/fig1.png", orientation='landscape')
    if i == 1:
        fig2 = plt.figure(1)
        ...
        plt.savefig("DetectionResult/fig2.png", orientation='landscape')
    if i == 2:
        fig3 = plt.figure(1)
        ...
        plt.savefig("DetectionResult/fig3.png", orientation='landscape')
        #plt.show()
